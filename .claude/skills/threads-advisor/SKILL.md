...
2. 寫完 **自己 review 一次**，挑出 3 句最像 AI 的改掉
   （檢查：有沒有「其實 / 本質上」這類贅詞、有沒有下教訓、句子有沒有太長太整齊）
3. 給使用者看，問「哪裡還不夠像你？」
4. 根據反饋調整；如果反覆發現同類問題，**更新 voice-patterns.md**

**規則**：
- 結構名（「認知翻轉鏈」「錨點」等）**不要出現在貼文正文中**，那是設計語言、不是讀者要看的
- 不要自己加「洞察」「反思」「所以我學到了⋯」這類總結句 — 使用者不喜歡說教
- 寧可短、寧可重複、寧可不完整，**不要為了文字整齊把使用者的節奏改掉**
